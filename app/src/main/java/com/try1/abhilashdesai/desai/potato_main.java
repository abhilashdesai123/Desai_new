...
public class potato_main extends Activity {
...
//int av=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.potato_main);
        ...
        chk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Cursor c=db2.rawQuery("SELECT * FROM works where type like 'Potato'", null);
                ...
                showMessage("potato Workers", buffer.toString());
            }
        });
        ...
        try {
            ...
            custom_potato adapter = new
                    custom_potato(potato_main.this, array, imageId);
...
////
                    try {
                        ...
                        db2.execSQL("INSERT INTO works VALUES('Potato','" + da + "','" + array[+position] + "' );");
                        if(gend.equals("Male"))
                        ...
                        Toast.makeText(getApplicationContext(), array[+position] + " Assigned to potato", Toast.LENGTH_SHORT).show();
